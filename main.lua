...
KeyBG.Image = "rbxassetid://100321299921257"
KeyBG.ScaleType = Enum.ScaleType.Crop
KeyBG.ImageTransparency = 0.3
KeyBG.Parent = KeyFrame

local KeyBlur = Instance.new("Frame")
KeyBlur.Size = UDim2.new(1, 0, 1, 0)
KeyBlur.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
KeyBlur.BackgroundTransparency = 0.5
KeyBlur.BorderSizePixel = 0
...
CheckKeyBtn.MouseButton1Click:Connect(function()
	if KeyInput.Text == "EL 01 HUB | ITACHI HUB" then
...
--// CARGAR HUB CON COLOR DE LA FOTO \\--
function LoadHub()
	...
	MainButton.Image = "rbxassetid://116305977254575"
	...
	--// MENÚ CON COLOR DE LA FOTO #14161E \\--
	local MainFrame = Instance.new("Frame")
	MainFrame.Name = "MainFrame"
	MainFrame.Size = UDim2.new(0, 550, 0, 320)
	MainFrame.Position = UDim2.new(0.5, -275, 0.5, -160)
	MainFrame.BackgroundColor3 = Color3.fromRGB(20, 22, 30) -- COLOR EXACTO DE TU FOTO
	...
	--// CONTENEDOR DERECHO CON COLOR DE LA FOTO \\--
	local ContentHolder = Instance.new("Frame")
	ContentHolder.Size = UDim2.new(1, -140, 1, -35)
	ContentHolder.Position = UDim2.new(0, 140, 0, 35)
	ContentHolder.BackgroundColor3 = Color3.fromRGB(20, 22, 30) -- MISMO COLOR QUE EL FONDO
	...
	ConfigListArrow.TextColor3 = Color3.fromRGB(200, 200, 200)
	...
	CreditsPanel.CanvasSize = UDim2.new(0, 0, 0, 260)
	CreditsPanel.Visible = false
	CreditsPanel.ZIndex = 1
	CreditsPanel.Parent = ContentHolder

	-- PRIMER CUADRO: EL 01 ROX HUB \\--
	...
	TikTok1.TextColor3 = Color3.fromRGB(200, 200, 200)
	TikTok1.TextSize = 12
	...
	TikTok2.TextColor3 = Color3.fromRGB(200, 200, 200)
	TikTok2.TextSize = 12
